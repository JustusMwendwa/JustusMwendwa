...
Hey there, I'm Justo — your friendly neighborhood bug whisperer 🐛✨ 
Coffee-powered ☕, code-obsessed 💻 and currently in a committed relationship with my keyboard (don't tell my IDE 😅). 
I turn caffeine into code, chaos into clean UIs and Stack Overflow tabs into solutions (most of the time).
...
![Justo's GitHub Stats](https://github-readme-stats.vercel.app/api?username=yourusername&show_icons=true&theme=radical&hide_border=true)
...
*(Add GitHub Activity Readme action to populate this)*
...
*(Add blog RSS feed to populate this)*

---

⚡ **Fun Fact:** The first computer bug was an actual moth stuck in a relay of the Harvard Mark II computer in 1947. As a bug whisperer, I've learned from the best! 🐛✨
